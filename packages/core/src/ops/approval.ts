 ...
 * the final gate is never automated). Runs INSIDE an already-open transaction:
 * `transaction()` cannot nest, and this body is shared by `reviewApprove` (human) and
 * `addComment`'s auto-approve hook (agent, clean doc-stage reviews).
 *
